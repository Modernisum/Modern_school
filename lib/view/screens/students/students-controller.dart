...
import 'package:modernschool/view/screens/students/studentsApi.dart';
...
// void check(){isExist.value=!isExist.value;update();}
  ...
  addStudent() async {
    ...
    update();
  } // improve - student add hone ke bad nevigate for student home screen
  ...
  getSearchStudents() async {
    print('getting New students ...');
    mystudents.value =
        await StudentApi.getsearchStudents(searchController.text);
    print('Done!');
    update();
  }
