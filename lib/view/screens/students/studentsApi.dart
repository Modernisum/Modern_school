...
class StudentApi {
  static addingStudent(
    ...
    }); // email exist then isExist function true
    ...
    if (isExist) {
      ...
      await FirebaseFirestore.instance
          ...
          }); // class-room in section and acadmic year are same show class id and student id
      ...
      await FirebaseFirestore.instance
        ...
        final data2 = {
          "uid": documentSnapshot.id, //where uid document id
        };
        await FirebaseFirestore.instance
            .collection('students')
