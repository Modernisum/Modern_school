...
class DailyCheckScreen extends StatelessWidget {
  const DailyCheckScreen({super.key, required this.checkController});
  final YourSchoolController checkController;
  @override
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: DropDownSelectingMenu(
                                            selectedOption: studentsController
                                                .selectedGrade2.value,
                                            selectOptions: studentsController
                                                .selectGradeOptions2,
                                            setSelectedOption:
                                                studentsController
                                                    .selectGradeOptions2,
