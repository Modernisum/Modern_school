...
import 'package:modernschool/models/emails.dart';
...
import 'package:modernschool/view/utils/widgets/items/email-item.dart';
import 'package:modernschool/view/utils/widgets/items/report-item.dart';

import '../../utils/constants/responsive.dart';
import '../../utils/widgets/header.dart';

class ReportsAndEmailsScreen extends StatelessWidget {
  const ReportsAndEmailsScreen({super.key});
...
class PickReportsOrEmails extends StatelessWidget {
  const PickReportsOrEmails({super.key});
